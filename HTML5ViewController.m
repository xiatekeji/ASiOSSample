...
@interface HTML5ViewController ()<UIWebViewDelegate, ASNavigatable>
...
-(void)initWebview
{
  ...
  //  NSURLRequest *request = [[NSURLRequest alloc] initWithURL:[NSURL URLWithString:_path]];
    [_webView loadData:[NSData dataWithContentsOfURL:[NSURL URLWithString:_path]] MIMEType: @"text/html" textEncodingName:@"UTF-8" baseURL:[NSURL URLWithString:@"http://icodeyp.sinaapp.com"]];
